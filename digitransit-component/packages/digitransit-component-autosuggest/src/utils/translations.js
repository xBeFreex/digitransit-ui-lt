const translations = {
  ...
  lt: {
    translation: {
      address: 'Adresas',
      'address-place-or-business': 'Adresas, vieta arba įmonė',
      ...
      arrival: 'Atvykimas',
      back: 'Atgal',
      bikepark: 'Dviračių stovėjimo aikštelė',
      bikerentalstation: 'Dviračių nuomos stotelė',
      bus: 'autobusas',
      cancel: 'Atšaukti',
      carpark: 'Automobilių stovėjimo aikštelė',
      'clear-button-label': 'Išvalyti',
      'clear-search-history': 'Išvalyti paieškos istoriją',
      currentposition: 'Dabartinė vieta',
      delete: 'Ištrinti',
      'delete-old-searches-header': 'Ar norite išvalyti paieškos istoriją?',
      departure: 'Išvykimas',
      destination: 'Tikslas',
      'give-origin': 'Įveskite išvykimo vietą.',
      'give-destination': 'Įveskite tikslą',
      favourite: 'Mėgstamas',
      ferry: 'Keltas',
      'future-route': 'Būsimas maršrutas',
      origin: 'Pradžia',
      'origin-stop-near-you': 'Pradžia',
      ownlocations: 'Mano vietos',
      loading: 'Kraunama...',
      'minute-short': 'min',
      platform: 'Peronas',
      rail: 'Traukinys',
      ...
      search: 'Ieškoti',
      'search-address-or-place': 'Ieškoti pagal adresą arba vietos pavadinimą',
      'search-button-label': 'Ieškoti',
      'search-destination': 'Ieškoti tikslo, linijos ar stotelės',
      'search-destination-index': 'Įveskite tikslą',
      'search-destination-results-but-no-search':
        'Peržiūrėti rezultatus skirtuke „Tikslas"',
      'search-no-results': 'Nieko nerasta',
      'search-origin': 'Ieškoti pradžios, linijos ar stotelės',
      'search-origin-index': 'Įveskite pradžios vietą',
      'search-position': 'Nustatyti vietą',
      'search-autosuggest-label': 'Vieta, linija ir stotelių paieška.',
      'search-autosuggest-label-instructions-desktop':
        'Naršykite sąrašą rodyklių klavišais ir pasirinkite Enter.',
      'search-autosuggest-label-instructions-mobile':
        'Įveskite vietą ir naršykite sąraše braukdami.',
      'search-autosuggest-label-move-to-destination':
        'Pasirinkus pradžios vietą automatiškai pereinama prie tikslo lauko.',
      'search-autosuggest-len': 'Yra {{count}} pasiūlymas',
      'search-autosuggest-len_plural': 'Yra {{count}} pasiūlymų',
      'search-current-suggestion': 'Dabartinis pasirinkimas: {{selection}}',
      street: 'Gatvė',
      subway: 'Metro',
      station: 'Stotis',
      stop: 'Stotelė',
      'stop-near-you': 'Ieškoti stotelių ir linijų',
      'stop-near-you-airplane': 'Ieškoti skrydžių ar oro uostų',
      'stop-near-you-bikepark': 'Ieškoti dviračių parkavimo',
      'stop-near-you-bus': 'Ieškoti autobusų linijų ar stotelių',
      'stop-near-you-carpark': 'Ieškoti automobilių stovėjimo aikštelių',
      'stop-near-you-citybike': 'Ieškoti miesto dviračių stotelių',
      'stop-near-you-rail': 'Ieškoti traukinių linijų ar stočių',
      'stop-near-you-subway': 'Ieškoti metro linijų ar stočių',
      'stop-near-you-tram': 'Ieškoti tramvajų linijų ar stotelių',
      'stop-route-station': 'Autobusų ir stotelių paieška',
      'today-at': 'šiandien',
      'tomorrow-at': 'rytoj',
      tram: 'Tramvajus',
      track: 'Bėgis',
      'use-own-position': 'Naudoti dabartinę vietą',
      'select-from-map': 'Pasirinkti vietą žemėlapyje',
      'select-from-own-locations': 'Pasirinkti iš savo vietų',
      venue: 'Vieta',
